...
format:
  html:
    output-file: "07_03_homework_one_way_anova_html.html"
  docx:
    output-file: "07_homework_one_way_anova.docx"
---
...
(Wisconsin) populations were grown in enclosures in northern Wisconsin
lakes during summer 2011.
...
We are going to do a one way ANOVA on invasive and native growth rates.
I am interested in seeing this overall... Is it the right test? Whats
wrong?
...
Note using a Type 3 Sums of Squares shows a slight difference due to the
unbalanced design
