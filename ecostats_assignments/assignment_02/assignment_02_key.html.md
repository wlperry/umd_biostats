---
title: "assignment_02_key"
author: "Bill Perry"
metadata-files:
  - ../../_templates/assignments.yml
format:
  html:
    output-file: "assignment_02_key.html"
  typst:
    output-file: "assignment_02_key.pdf"
editor: visual
---
...
```{.r .cell-code}
lake_df <- read_csv("data/cheruvelil_lake_data.csv") %>% clean_names()
```
...
lake_df <- lake_df %>% 
  mutate(
    ...
    log_chl_ug_l      = log10(chl_ug_l),           # Log chlorophyll (response)
    log_tn_ug_l       = log10(tn_ug_l),            # Log total nitrogen
    log_tp_ug_l       = log10(tp_ug_l),            # Log total phosphorus
...
# ℹ 14 more variables: year <dbl>, chl_ug_l <dbl>, tn_ug_l <dbl>,
...
|:--------------------|---------:|-------------:|----------:|---------:|----------:|----------:|----------:|----------:|----------:|:-----|
|longitude_utm        |         0|             1|  643989.35| 282496.03|  -37508.79|  436118.90|  772612.27|  862228.33| 1048083.47|▂▃▃▅▇ |
|latitude_utm         |         0|             1| 2349913.86| 198036.63| 1956356.03| 2182084.72| 2345964.32| 2517187.79| 2745426.16|▃▇▅▇▅ |
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/unnamed-chunk-7-1.png){width=672}
:::
:::
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/corre_plots-1.png){width=672}
:::
:::
...
## Intial Multiple Regression# Start the multiple regression
...
Call:
lm(formula = chl_ug_l ~ tn_ug_l + tp_ug_l + area_km2 + z_mean_m + 
...
tn_ug_l               0.002850   0.000708   4.026 6.42e-05 ***
tp_ug_l               0.272648   0.016078  16.958  < 2e-16 ***
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/unnamed-chunk-8-1.png){width=672}
:::
:::
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/partial-plots-1.png){width=672}
:::
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/unnamed-chunk-9-1.png){width=672}
:::
...
## Multiple Regression wiht logged response variable
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/unnamed-chunk-10-1.png){width=672}
:::
:::
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/partial-plots_2-1.png){width=672}
:::
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/unnamed-chunk-11-1.png){width=672}
:::
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/unnamed-chunk-12-1.png){width=672}
:::
:::
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/partial-plots_3-1.png){width=672}
:::
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/unnamed-chunk-13-1.png){width=672}
:::
...
## AIC is way better for log respinse and a bit better for log all but still messy...
...
::: {.cell-output-display}
![](assignment_02_key_files/figure-html/final_summary_plot-1.png){width=672}
:::
:::
