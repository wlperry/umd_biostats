...
```
95% CI using z: 236.1 to 279.3 mm
```
...
```
95% CI using t: 232.8 to 282.6 mm
```
...
::: {.cell}
::: {.cell-output-display}
![](04_01_lecture_powerpoint_files/figure-pptx/unnamed-chunk-25-1.png)
:::
:::
