...
```
95% CI using z: 266.2 to 280.8 mm
```
...
```
95% CI using t: 265.1 to 281.9 mm
```
...
::: {.cell}
::: {.cell-output-display}
![](04_01_lecture_powerpoint_files/figure-docx/unnamed-chunk-20-1.png)
:::
:::
