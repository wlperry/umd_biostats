...
**What we changed:** - Increased variance in Knees group - Added extreme
outliers to Eyes group - Created unequal variances and non-normality
:::
...
::: {.cell-output-display}
![](11_01_lecture_powerpoint_files/figure-docx/violated_data_plot-1.png)
:::
...
::: {.cell}
::: {.cell-output-display}
![](11_01_lecture_powerpoint_files/figure-docx/violated_normality_plot-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![](11_01_lecture_powerpoint_files/figure-docx/violated_variance_plot-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![](11_01_lecture_powerpoint_files/figure-docx/kruskal_ranks_plot-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![](11_01_lecture_powerpoint_files/figure-docx/violated_comparison_plot-1.png)
:::
:::


**Why Kruskal-Wallis is robust:** - Uses ranks instead of raw values -
Outliers affect ranks minimally - Unequal variances less problematic -
