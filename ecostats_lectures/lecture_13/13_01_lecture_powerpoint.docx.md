...
::: {.cell-output-display}
![](13_01_lecture_powerpoint_files/figure-docx/unnamed-chunk-1-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![](13_01_lecture_powerpoint_files/figure-docx/diagnostic_plots-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![](13_01_lecture_powerpoint_files/figure-docx/boxplot-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![](13_01_lecture_powerpoint_files/figure-docx/means_plot-1.png)
:::
:::
...
u_anova_summary
##             Df Sum Sq Mean Sq F value    Pr(>F)    
## treat        3  14429  4809.7 16.1075 6.579e-08 ***
## treat:patch 12  21242  1770.2  5.9282 8.323e-07 ***
## Residuals   64  19110   298.6                      
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## p Patch(Treatment): 8.322613e-07
```
:::
